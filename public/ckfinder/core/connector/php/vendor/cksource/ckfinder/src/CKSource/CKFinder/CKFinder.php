...
class CKFinder extends Container implements HttpKernelInterface
{
    ...
    {
        $errorMessage = 'The PHP installation does not meet the minimum setting requirements for CKFinder. %s Please refer to CKFinder documentation for more details.';
